 ...
 */
function callLLM(provider, query) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    _a.sent();
                    if (provider === 'claude') {
                        return [2 /*return*/, "Claude Response to \"".concat(query, "\": Embracing your emotional depth and intuitive insight.")];
                    }
                    else {
                        return [2 /*return*/, "GPT Response to \"".concat(query, "\": Here is a structured analysis and strategic advice.")];
                    }
                    return [2 /*return*/];
            }
        });
