/*
  # Collective Wisdom System Schema

  1. New Tables
    - `memory_items`: Stores insights and responses from specialized agents
    - `memory_patterns`: Stores detected patterns and themes
    - `memory_aggregations`: Stores synthesized collective wisdom
