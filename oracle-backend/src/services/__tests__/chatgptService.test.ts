...
describe('ChatGPT Service', () => {
  ...
  it('should generate a response successfully', async () => {
    ...
    (OpenAI.prototype.chat.completions.create as jest.Mock).mockResolvedValue(mockCompletion);
  ...
  it('should handle errors gracefully', async () => {
    ...
    (OpenAI.prototype.chat.completions.create as jest.Mock).mockRejectedValue(mockError);
