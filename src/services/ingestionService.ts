...
export async function ingestFromNotion(): Promise<{ processed: number; results: Result<any>[] }> {
...
export async function ingestFromLocal(): Promise<{ processed: number; results: Result<any>[] }> {
