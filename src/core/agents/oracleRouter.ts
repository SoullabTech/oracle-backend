  ...
  return (
    <Card className="p-4 space-y-4">
      ...
      <div className="flex space-x-2">
        ...
        />
        <Button onClick={handleAsk}>Ask Oracle</Button>
      </div>
      <input
        value={search}
      ...
      />
      <CardContent className="whitespace-pre-line bg-muted p-4 rounded">
        {response || "Awaiting divine reply..."}
      </CardContent>
      {filteredHistory.length > 0 && (
        <div className="h-96 mt-6">
          <h3 className="font-semibold mb-2">Constellation Map</h3>
          <ForceGraph2D
