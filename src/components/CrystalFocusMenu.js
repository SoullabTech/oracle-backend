      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("h2", {
            ...
            children: "Choose Your Crystal Focus",
          }),
          _jsx("p", {
      ...
      _jsxs("form", {
        ...
        children: [
          _jsx("div", {
            ...
            children: CRYSTAL_FOCUS_OPTIONS.map((option) =>
              _jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    ...
                    option.elements.length > 0 &&
                      _jsxs("div", {
                        ...
                        children: ["Elements: ", option.elements.join(", ")],
                      }),
                  ],
                },
                option.type,
              ...
              children: [
                  ...
                  _jsxs("div", {
                    children: [
                      _jsx("label", {
                        ...
                        children: "Describe your focus area",
                      }),
                      _jsx("input", {
                        type: "text",
                ...
                _jsxs("div", {
                  children: [
                    _jsx("label", {
                      className: "block text-sm font-medium text-gray-700 mb-1",
                      children: "What do you hope to achieve or experience?",
                    }),
                    _jsx("textarea", {
                      value: aspirations,
