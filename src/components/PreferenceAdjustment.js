...
export function PreferenceAdjustment() {
  ...
  const currentProfile = queryClient.getQueryData(["profileStats", user?.id]);
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("h2", {
        ...
        children: "Adjust Your Preferences",
      }),
      _jsxs("form", {
        ...
        children: [
            ...
            _jsxs(
              "div",
              {
                children: [
                  _jsx("label", {
                    className:
                      "block text-sm font-medium text-gray-700 mb-2 capitalize",
                    children: element,
                  }),
                  _jsx("input", {
                    type: "range",
          ...
          _jsx("button", {
            ...
            className:
              "w-full px-4 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors",
