...
export function ElementalProfileDisplay() {
  ...
  return _jsxs("div", {
    ...
    children: [
            ...
            _jsxs("div", {
              ...
              children: [
                _jsxs("h3", {
                  ...
                  children: ["Crystal Focus: ", crystalFocus.type],
                }),
                crystalFocus.type === "other" &&
                  crystalFocus.customDescription &&
                  _jsx("p", {
                    className: "text-gray-600 mb-2",
                    children: crystalFocus.customDescription,
                  }),
              ],
            }),
        ],
      ...
      _jsx("div", {
        className: "space-y-4",
        children: Object.entries(profile)
          .filter(([key]) =>
            ["fire", "water", "earth", "air", "aether"].includes(key),
          )
          .map(([element, score]) =>
            _jsxs(
              "div",
                  ...
                  _jsxs("div", {
                    ...
                    children: [
                      _jsx("div", {
                        children: _jsx("span", {
                          className:
                            "text-xs font-semibold inline-block uppercase",
                          children: element,
                        }),
                      }),
                      _jsx("div", {
      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("h4", {
            className: "font-semibold mb-2",
            children: "Personality Adjustment",
          }),
          _jsxs("div", {
            className: "space-y-2",
            children: [
              _jsxs("p", {
                className: "text-gray-600",
                children: [
                  _jsx("span", { className: "font-medium", children: "Tone:" }),
                  " ",
                  personalityAdjustment.tone,
                ],
              }),
              _jsxs("p", {
                className: "text-gray-600",
