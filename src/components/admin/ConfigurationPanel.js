          ...
          _jsxs("div", {
            children: [
              _jsx("h3", {
                ...
                children: "Elemental Weights",
              }),
              _jsx("div", {
                className: "grid grid-cols-2 md:grid-cols-5 gap-4",
                children: Object.entries(config.elementalWeights).map(
                  ([element, weight]) =>
                    _jsxs(
                      "div",
                      {
          ...
          _jsxs("div", {
            children: [
              ...
              _jsx("div", {
                ...
                children: Object.entries(config.confidenceThresholds).map(
                  ([key, value]) =>
                    _jsxs(
                      "div",
                      {
