...
export function DashboardOverview() {
  ...
  if (isLoading) {
    return _jsxs("div", {
      ...
      children: [
        _jsx("div", { className: "h-8 bg-gray-200 rounded w-1/4" }),
        _jsx("div", {
          className: "grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4",
          children: [...Array(4)].map((_, i) =>
            _jsx("div", { className: "h-32 bg-gray-200 rounded-lg" }, i),
          ),
        }),
        _jsx("div", { className: "h-96 bg-gray-200 rounded-lg" }),
      ],
    });
  }
  const stats = [
    ...
    children: [
      _jsxs("div", {
        children: [
          ...
          _jsxs("p", {
            ...
            children: ["Last updated: ", format(new Date(), "PPpp")],
          }),
        ],
      }),
      _jsx("div", {
                      ...
                      _jsxs("p", {
                        ...
                        children: [
                          item.changeType === "positive"
                            ...
                            : _jsx(ArrowDownIcon, {
                                className:
                                  "h-5 w-5 flex-shrink-0 self-center text-red-500",
                              }),
                          _jsxs("span", {
                            className: "sr-only",
                            children: [
      ...
      _jsxs("div", {
        ...
        children: [
          ...
          _jsx(AskOracle, { userId: currentUser.id }),
        ],
      }),
    ],
  });
