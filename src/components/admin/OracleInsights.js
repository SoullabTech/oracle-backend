      ...
      _jsxs("div", {
        ...
        children: [
          _jsx("h2", {
            ...
            children: "Recent Wisdom",
          }),
          _jsx("div", {
            className: "space-y-4",
            children: wisdom?.slice(0, 5).map((item) =>
              _jsxs(
                "div",
                {
                ...
                "div",
                {
                  ...
                  children: [
                    _jsx("h3", {
                      ...
                      children: pattern.patternType,
                    }),
                    _jsx("p", {
                      className: "mt-1 text-gray-600",
                      children: pattern.patternData.description,
                    }),
                    _jsxs("div", {
                        ...
                        _jsxs("div", {
                          ...
                          children: [
                            _jsxs("span", {
                              ...
                              children: ["Frequency: ", pattern.frequency],
                            }),
                            _jsxs("span", {
                              className: "text-sm text-gray-500",
                              children: [
