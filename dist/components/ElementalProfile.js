...
export function ElementalProfile() {
    ...
    return (_jsxs("div", { className: "bg-white rounded-lg shadow-md p-6", children: [_jsxs("div", { className: "mb-6", children: [_jsx("h2", { className: "text-2xl font-bold mb-2", children: "Your Elemental Profile" }), focusOption && (_jsxs("div", { className: "mb-4", children: [_jsx("h3", { className: "text-lg font-semibold mb-2", children: focusOption.title }), _jsx("p", { className: "text-gray-600", children: crystalFocus?.customDescription || focusOption.description })] }))] }), _jsxs("div", { className: "space-y-4", children: [_jsx(ElementalScore, { element: "fire", score: profile.fire }), _jsx(ElementalScore, { element: "water", score: profile.water }), _jsx(ElementalScore, { element: "earth", score: profile.earth }), _jsx(ElementalScore, { element: "air", score: profile.air }), _jsx(ElementalScore, { element: "aether", score: profile.aether })] }), crystalFocus && (_jsxs("div", { className: "mt-6 space-y-4", children: [_jsxs("div", { children: [_jsx("h4", { className: "font-semibold mb-2", children: "Current Challenges" }), _jsx("p", { className: "text-gray-600", children: crystalFocus.challenges })] }), _jsxs("div", { children: [_jsx("h4", { className: "font-semibold mb-2", children: "Aspirations" }), _jsx("p", { className: "text-gray-600", children: crystalFocus.aspirations })] })] }))] }));
}
