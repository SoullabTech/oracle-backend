...
describe("Notion Service", () => {
    ...
    describe("fetchNotionPages", () => {
        it("should fetch and transform pages", async () => {
            ...
            Client.prototype.databases.query.mockResolvedValue({
                results: mockPages,
            });
            Client.prototype.blocks.children.list.mockResolvedValue(mockBlocks);
        ...
        it("should handle fetch errors", async () => {
            Client.prototype.databases.query.mockRejectedValue(new Error("API error"));
            await expect(fetchNotionPages("test-db")).rejects.toThrow("Failed to fetch Notion pages");
        });
    });
