import { storeWisdom, getWisdomByElements, getPatternsByFacets, getConnectedWisdom, } from "../collectiveWisdomService";
...
describe("Collective Wisdom Service", () => {
    ...
    describe("getWisdomByElements", () => {
        it("should fetch wisdom by elements", async () => {
            ...
            supabase.from().select().contains().gte().order().limit.mockResolvedValue({
                data: mockWisdom,
                error: null,
            });
    ...
    describe("getPatternsByFacets", () => {
        it("should fetch patterns by facets", async () => {
            ...
            supabase.from().select().contains().gte().order.mockResolvedValue({
                data: mockPatterns,
                error: null,
            });
