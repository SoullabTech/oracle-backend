...
export async function registerIntegration(integration) {
    try {
...
export async function getIntegrationConfig(serviceName) {
    try {
        const { data, error } = await supabase
            .from("oracle_integrations")
            .select("*")
...
export async function updateIntegrationStatus(id, status, metrics) {
    try {
