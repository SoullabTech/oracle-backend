...
import { getRelevantMemories, storeMemoryItem, } from '../services/memoryService.ts';
const router = Router();
...
router.post("/", async (req, res) => {
    try {
        ...
        const story = await elementalOracle.generateStory({ elementalTheme, archetype, focusArea, depthLevel }, context);
        const content = [
