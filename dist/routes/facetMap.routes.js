...
import { detectFacetFromInput } from '../services/facetService.ts';
// after
import { elementalFacetMap } from '../constants/elementalFacetMap.ts';
const router = Router();
/**
...
router.post("/detect", (req, res) => {
    ...
    try {
        ...
        const facetInfo = elementalFacetMap[element];
        if (!facetInfo) {
            return res
                .status(404)
